...
namespace CamQuizz.Migrations
{
    ...
    [Migration("20250723031933_FixLastReadMessageMember")]
    partial class FixLastReadMessageMember
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CamQuizz.Domain.Entities.GroupMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CamQuizz.Domain.Entities.UserGroup", b =>
                {
                    ...
                    b.HasOne("CamQuizz.Domain.Entities.GroupMessage", "LastReadMessage")
                        .WithMany("LastReadMembers")
